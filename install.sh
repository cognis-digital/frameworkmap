#!/usr/bin/env sh
# Universal installer for frameworkmap. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/frameworkmap.git"
echo "Installing frameworkmap ..."
...
echo "Done. Run: frameworkmap --help"
