"""FRAMEWORKMAP core — Crosswalk controls across NIST, ISO 27001, SOC 2, CMMC, PCI."""
...
RULES = [
    ("FRA-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("FRA-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("FRA-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
