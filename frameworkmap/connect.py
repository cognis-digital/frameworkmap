"""Native cognis-connect emit for frameworkmap — forward findings to any platform.

Maps frameworkmap's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    frameworkmap ... --format json | frameworkmap-emit --to stix
    frameworkmap-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
