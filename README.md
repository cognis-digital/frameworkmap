...
[![PyPI](https://img.shields.io/pypi/v/cognis-frameworkmap.svg)](https://pypi.org/project/cognis-frameworkmap/)
[![CI](https://github.com/cognis-digital/frameworkmap/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/frameworkmap/actions)
...
FRAMEWORKMAP exists for one job — crosswalk controls across nist, iso 27001, soc 2, cmmc, pci — and does it without a SaaS bill or heavyweight setup.
...
frameworkmap scan .                      # scan the current project
frameworkmap scan . --format json
frameworkmap scan . --fail-on high       # non-zero exit for CI gates
frameworkmap mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **CISO Assistant**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`frameworkmap` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
